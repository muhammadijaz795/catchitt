...
const StoryEditor = ({file}:any) => {
    ...
    const postStory = () => {
        ...
        console.log("video blob before adding to formData")
    ...
    const renderCanvas = () => {
        ...
        canvas.getObjects().forEach(function (obj: any) {
            console.log();
            console.log('object tyep ', obj.type);
   ...
   const startRecording = () => {
        if (!isRecording) {
            ...
            console.log('chunks while starting stopping');
            console.log(chunks);
    ...
    const handleColorChange = (e:any) => {
        ...
        if (activeObject) {
            if (activeObject.type === 'rect' || activeObject.type === 'circle' || activeObject.type === 'triangle' || activeObject.type === 'ellipse' || activeObject.type === 'path' || activeObject.type === 'polygon') {
        ...
        <div className="w-[100%] relative h-[100vh]  flex flex-col justify-center items-center pt-[5rem]">
            ...
            <div className="flex  w-[28rem]   min-w-[30%] h-[650px] bg-custom-light xl:w-[31.5rem] rounded-[0.5rem] ">
               ...
               <div className='flex flex-col gap-[2rem] pt-[1rem] border items-center w-[70px] h-[600px] '>
                    <span className={styles.spanBtn} onClick={rect}><RectangleIcon/></span>
                    <span className={styles.spanBtn} onClick={text}><TextIcon /></span>
                    ...
                    <span className={styles.spanBtn} ><AtTheRate/></span>
                    {/* <span className={styles.spanBtn} onClick={exportVideo}>export</span> */}

                    {/* <button onClick={startRecording}>Start Recording</button>
                    <button onClick={stopRecording}>Stop Recording</button> */}
                    <input type="color" style={{width:'20px', height:'20px'}}  onChange={handleColorChange} />
                    <input type="color" style={{width:'20px', height:'20px'}}  onChange={handleBGColorChange} />
               </div>
               ...
               <div
                ...
                >
                    ...
                    <div className="flex border relative flex-col items-center gap-[0.5rem]">
                       
                    </div>

                </div>
            </div>
            <div className='w-[25rem] h-[5px] flex justify-end py-2 border'>
