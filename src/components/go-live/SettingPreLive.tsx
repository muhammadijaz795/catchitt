...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ profileDetails, customProps, onSettingsChange  }) => {
  ...
  { title: t('livestream.about_me'), description: t('livestream.introduce_yourself'), type: 'link', component: 'AboutMe'  as const },
  ...
  { title: t('livestream.comment_settings'), type: 'link', component: 'comments'  as const },
  // { title: 'Content disclosure', type: 'link' },
  { title: 'Muted Accounts', description: t('livestream.muted_account_description'), type: 'link', component: 'MutedAccounts'  as const },
  { title: t('livestream.blocked_account'), type: 'link', component: 'BlockedAccounts'  as const },
];
      ...
      {activeView === null ? (
        <Box sx={{ width: 360, mx: 'auto', position: 'fixed', right: 0, top: 0, height: '100vh', bgcolor: '#fff', zIndex: 2 }}>
          ...
          <Typography variant="body2" fontWeight={600} textAlign="left" color="text.secondary" sx={{ mt: 1, mb: 2, pl: 1.5 }}>
            {t('livestream.these_settings_apply_to_all_videos')}
          </Typography>
