            ...
            <div className="flex" >
                ...
                <Box sx={{ position: "absolute", bottom: 0, width: "100%" }}>
                    ...
                    >
                        ...
                        <ControlItem onClick={toggleSettings} icon={<SettingsIcon />} label={t('livestream.settings')} />
                        {/* Phase 2 */}
                        {/* {expanded ? (
                            <ControlItem icon={<Activity />} label="Activities" />
                        ) : (
                            <ControlItem
                            onClick={toggleMoreExpenstion}
                            icon={
                                <Box
                        ...
                        <Box mt={2} display="flex" justifyContent="space-between">
                            <ControlItem icon={<Board />} label="Boards" />
                            <ControlItem icon={<Dual />} label="Dual" />
                            <ControlItem icon={<Share />} label="Share" />
                            <ControlItem icon={<LiveCenter />} label="Live Center" />
                        </Box>
                        <Box mt={2} display="flex" justifyContent="space-between">
                            <ControlItem icon={<Leads />} label="Leads" />
                            <ControlItem icon={<Poll />} label="Poll" />
                            <ControlItem icon={<Promote />} label="Promote" />
                            {/* "Less" Button at bottom right */}
                            <ControlItem
                            icon={
                                <Box
                                onClick={toggleMoreExpenstion}
                                ...
                                >
                                <ExpandLess sx={{ color: 'white', fontSize: 18 }} />
                                </Box>
                            }
                            label="Less"
                            />
                    ...
                    ref={slideRef}
                        sx={{
                           position:"absolute",
                            ...
                            width:"100%",
                            height:"19rem",
                            background: '#00000080', // Replace with your background
                        }}
                        >
                        {/* Top bar */}
                        <Box
                        ...
                        >
                            ...
                            <path opacity="0.6" d="M3.90278 3.90131L17.0972 17.0958M10.5 19.9985C5.2533 19.9985 1 15.7453 1 10.4985C1 5.25183 5.2533 0.998535 10.5 0.998535C15.7467 0.998535 20 5.25183 20 10.4985C20 15.7453 15.7467 19.9985 10.5 19.9985Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <Typography color="white" ml={1}>My Filters</Typography>
                            </Box>
                            <IconButton onClick={toggleExplore}>
                        ...
                        {/* Filter grid */}
                        <Box sx={{overflow: 'auto', height: '14rem', px: 2}}>
                            <Grid container spacing={2}  >
                                {filters.map(({ id, image, selected, disabled }) => (
                                <Grid item xs={3} sm={2} md={1.5} key={id}>
                                    <Paper
                ...
                <Box >
                     ...
                     <Box
                        ...
                        <Box sx={{ display: "flex", alignItems: "flex-end", gap: 1 }}>
                            ...
                            <InputBase
                                ...
                                placeholder={t('livestream.add_title')}
                                autoFocus
                                sx={{
                                input: {
                            ...
                            >
                                {liveTitle ||t('livestream.add_title')}
                            </Typography>
                            )}
                    ...
                    <CardContent sx={{ padding: 0 }}>
                            ...
                            {t('livestream.edit_your_live_goal')}
                            </Button>
                            {/* <Button
                            fullWidth
