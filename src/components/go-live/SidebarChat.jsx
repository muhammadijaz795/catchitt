...
const SidebarChat = ({ selectedLiveVideo, showSidebar, onHideSidebar }) => {
  ...
  const handleSendMessage = () => {
    if (message.trim()) {
      const newMessage = {
        ...
        name: 'You',
        userImage: 'https://i.pravatar.cc/50?img=7',
        text: message
      };
                            ...
                            <Box>
                                ...
                                <Box sx={{  height: 'calc(100vh - 14.5rem)', overflowY: 'auto' }}>
                                          <Box sx={{ px: 2, py: 1, height: 'calc(100vh - 14.5rem)', overflowY: 'auto' }}>
                                            ...
                                            >
                                            <Typography fontSize={12} color="text.secondary">🌿 ABC joined</Typography>
