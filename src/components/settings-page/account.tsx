...
const Account = ({ className, openModal }: AccountProps) => {
    const { t, i18n } = useTranslation();    const API_KEY = process.env.VITE_API_URL;
                ...
                <div className={`${styles.container} position-relative`} style={{ maxWidth: '1140px', margin: 'auto', paddingTop: '7rem' }}>
                    ...
                    <span onClick={handleBackClick} className={` ${darkTheme ? '' : 'bg-gray-200' }   position-absolute cursor-pointer p-2 rounded-full`} style={{right: '107%'}}>
                        ...
                        <div onClick={() => navigateToSection('manage_account')}  className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'manage_account' ? sibarStyles.active : ''}`} >
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}> {t('Manage.account')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div onClick={() => navigateToSection('download_data')}  className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'download_data' ? sibarStyles.active : ''}`}>
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Privacy')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div onClick={() => navigateToSection('push_notification')} className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'push_notification' ? sibarStyles.active : ''}`}>
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Push.notifications')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div onClick={() => navigateToSection('business_account')}  className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'business_account' ? sibarStyles.active : ''}`}>
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Business.account')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div onClick={() => navigateToSection('ads')} className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'ads' ? sibarStyles.active : ''}`}>
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Ads')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div  onClick={() => navigateToSection('screen_time')}  className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'screen_time' ? sibarStyles.active : ''}`} >
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Screen.time')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                        <div onClick={() => navigateToSection('filter_keywords')} className={`${sibarStyles.sideNavDiv} pt-4 cursor-pointer ${activeItem === 'filter_keywords' ? sibarStyles.active : ''}`}>
                            ...
                            <p className={`${sibarStyles.linkWord} pl-2`}>{t('Content.preferences')}</p>
                            </div>
                            {/* </Link> */}
                        </div>
                    </div> }
                    <div className={` ${styles.middleSectionDiv}  shadow-md text-left`}  style={{ display: visibleDiv === 'download_data' ? 'block' : 'none' }}>
                        <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-semibold p-3 text-xl`}>{t('Download.Seezitt.data')}</h4>
                    ...
                    <div className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'adds' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-semibold text-xl p-3`}>{t('How.ads.are.personalized')}</h4>
                            <span className='text-left px-3 text-[#000000A6] d-block text-sm'> {t('Ads.personalized.description')}
                            <a href="" className='font-semibold'>{t('Learn.more')}</a>
                        </span>
                        <Ads /> 
                    </div>
                    ...
                    <div className={` ${styles.middleSectionDiv}  shadow-md text-left`} style={{ display: visibleDiv === 'mute_advertisers' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-semibold text-xl p-3`}>{t('Mute.advertisers')}</h4>
                            <p className='text-left px-3 text-[#000000A6] text-sm'> 
                                {t('Mute.advertisers.description')}
                            </p>
                        <MuteAdvertisers />
                        <span className='text-left px-3 text-[#000000A6] text-sm'> 
                            {t('Advertisers.you.have.hidden')}
                        </span>
                    </div>
                    <div  className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'daily_screen_time' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-bold text-xl p-3`}>{t('Daily.screen.time')}</h4>
                            <span className='text-left px-3 text-[#161823] pt-1 text-sm'> 
                            {t('Daily.screen.time.description')}
                            </span>
                        <DailyScreenTime />
                    </div>
                    <div className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'screen_time_breaks' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-bold text-xl p-3`}>{t('Screen.time.breaks')}</h4>
                            <span className='text-left px-3 text-[#161823] pt-1 text-sm'> 
                            {t('Screen.time.breaks.description')}
                            </span>
                        <ScreenTimeBreaks />
                    </div>
                    <div className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'sleep_reminders' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-bold text-xl p-3`}>{t('Sleep.reminders')}</h4>
                            <span className='text-left px-3 text-[#161823] pt-1 text-sm'> 
                                {t('Sleep.reminders.description')}
                            </span>
                        <SleepReminder />
                    </div>
                    <div className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'filter_keywords' ? 'block' : 'none' }}>
                    {!addKeywordPage && <><h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-bold text-xl p-3`}>{t('Filter.keywords')}</h4><span className='text-left px-3 d-block text-[#161823] pt-1 text-sm'>
                            {t('Filter.keywords.description')}
                        </span></>}
                    ...
                    <div className={` ${styles.middleSectionDiv}   shadow-md text-left`} style={{ display: visibleDiv === 'disconnect_advertisers' ? 'block' : 'none' }}>
                            <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0 font-semibold text-xl p-3`}>{t('Disconnect.advertisers')}</h4>
                            <ul className='list-disc pl-5 ml-3 text-left px-3 text-sm'>
                                <li>{t('Disconnect.advertisers.1')}</li>
                                <li>{t('Disconnect.advertisers.2')}</li>
                            </ul>
                        ...
                        <div className={styles.settingsWrapper}>
                            ...
                            <div  className={styles.suggestedContent}>
                                <div className={`${styles.pageHeader} mb-0 mt-2`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0`}>{t('Manage.account')}</h4>
                                </div>
                                {/* <div
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                                ...
                                <div  className='w-100 border-bottom pb-3'>
                                    <h5  ref={sectionRefs.manage_account}  className='h6 text-left'>{t('Account.control')}</h5>
                                    <div
                                        className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            <p >{t('Delete.account')}</p>
                                        </div>
                                        <p onClick={handleOpenDeleteAccountMainModal} style={{ color: '#FE2C55' }}>{t('Delete')}</p>
                                    </div>
                                </div>
                            </div>
                            <div ref={sectionRefs.download_data} className={`${styles.suggestedContent} scroll-section`}>
                                <div  className={`${styles.pageHeader} mb-0 mt-0`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0`}>{t('Privacy')}</h4>
                                </div>
                                <div className='w-100 border-bottom pb-3'>
                                    <h5 className='h6 text-left'>{t('Discoverability')}</h5>
                                    <div
                                        className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p>{t('Private.account')}</p>
                                            <span className='text-xs text-[#16182399]'>{t('Private.account.description')}</span>
                                            </div>
                                        </div>
                                ...
                                <div  className='w-100 border-bottom pb-3' onClick={() => toggleVisibility('download_data')}>
                                    <h5 className='h6 text-left'>{t('Data')}</h5>
                                    <div
                                        className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p>{t('Download.your.data')}</p>
                                            <span className='text-xs text-[#16182399]'>{t('Download.your.data.description')}</span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                            ...
                            <div  ref={sectionRefs.push_notification} className={`${styles.suggestedContent} mb-0`}>
                                <div className={`${styles.pageHeader} mb-0 mt-0`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0`}>{t('Push.notifications')}</h4>
                                </div>
                                <div className='w-100 border-bottom pb-3'>
                                    <h5 className='h6 text-left'>{t('Desktop.notifications')}</h5>
                                    <div
                                        className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p>{t('Allow.in.browser')}</p>
                                            <span className='text-xs text-[#16182399]'>{t('Allow.in.browser.description')}</span>
                                            </div>
                                        </div>
                                ...
                                <div className='w-100 border-bottom pb-3'>
                                    <h5 className='h6 text-left'>{t('Your.preferences')}</h5>
                                    <span className='text-xs text-[#16182399] d-block text-left mb-3'>{t('Your.preferences.description')}</span>
                                    ...
                                    <Accordion className={ `${darkTheme ? 'bg-transparent': 'bg-[#f8f8f8]'} shadow-none  px-0`}>
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                                <p>{t('Interactions')} </p>
                                                <span className='text-xs text-[#16182399]'>L{t('Interactions.description')}</span>
                                            </div>
                                        </div>
                                        </AccordionSummary>
                                        <AccordionDetails className={ `${darkTheme ? 'bg-transparent': 'bg-[#f8f8f8]'}   px-1`}>
                                            <Typography >
                                                <div
                                                    ...
                                                    <div className={styles.settingName}>
                                                        <div className='text-left'>
                                                            <p className='text-base'>{t('Likes')}</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <Typography className='mt-4'>
                                                <div
                                                    ...
                                                    <div className={styles.settingName}>
                                                        <div className='text-left'>
                                                            <p className='text-base'>{t('Comments')}</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <Typography className='mt-4'>
                                                <div
                                                    ...
                                                    <div className={styles.settingName}>
                                                        <div className='text-left'>
                                                            <p className='text-base'>{t('New.followers')}</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <Typography className='mt-4'>
                                                <div
                                                    ...
                                                    <div className={styles.settingName}>
                                                        <div className='text-left'>
                                                            <p className='text-base'>{t('Mentions.and.tags')}</p>
                                                        </div>
                                                    </div>
                            ...
                            <div className={`${styles.suggestedContent} py-0`}>
                                <div className='w-100 border-bottom pb-0'>
                                    <Accordion className={ `${darkTheme ? 'bg-transparent': 'bg-[#f8f8f8]'} shadow-none  px-0`}>
                                        ...
                                        aria-controls="panel2-content"
                                        id="panel2-header">
                                         <p className='h6 text-left'>{t('In.app.notifications')}</p>
                                        </AccordionSummary>
                                        <AccordionDetails className={ `${darkTheme ? 'bg-transparent': 'bg-[#f8f8f8]'}   px-1`}>
                                            <Typography >
                                                <div
                                            ...
                                            <Typography className='mt-4'>
                                                <div
                                                    ...
                                                    <div className={styles.settingName}>
                                                        <div className='text-left'>
                                                            <p className='text-base'>{t('Reposts')}</p>
                                                        </div>
                                                    </div>
                            ...
                            <div  ref={sectionRefs.business_account} className={styles.suggestedContent}>
                                <div className='w-100 border-bottom pb-3'>
                                <div className={`${styles.pageHeader} mb-0 mt-0`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-3`}>{t('Business.account')}</h4>
                                </div>
                                    <div
                                        className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <h5 className='h6 text-left'>{t('Business.account')}</h5>
                                            <span className='text-xs text-[#16182399]'>{t('Business.account.description')}</span>
                                            </div>
                                        </div>
                            ...
                            <div ref={sectionRefs.ads} className={`${styles.suggestedContent} gap-0`}>
                                <div className='w-100 border-bottom pb-3'>
                                <div className={`${styles.pageHeader} mb-0 mt-0`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-3`}>{t('Ads')}</h4>
                                </div>
                                    <div
                                        className={styles.accountCards} onClick={() => toggleVisibility('adds')}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <h5 className='h6 text-left'>{t('Manage.the.ads.you.see')}</h5>
                                            ...
                                            <path d="M6.6 4.97383C6.6 5.71643 6.305 6.42863 5.7799 6.95373C5.2548 7.47883 4.54261 7.77383 3.8 7.77383C3.05739 7.77383 2.3452 7.47883 1.8201 6.95373C1.295 6.42863 1 5.71643 1 4.97383C1 4.23122 1.295 3.51903 1.8201 2.99393C2.3452 2.46883 3.05739 2.17383 3.8 2.17383C4.54261 2.17383 5.2548 2.46883 5.7799 2.99393C6.305 3.51903 6.6 4.23122 6.6 4.97383ZM7.55 4.11383C7.55534 4.13614 7.5682 4.15593 7.58641 4.16989C7.60461 4.18385 7.62707 4.19113 7.65 4.1905C8.75693 4.19133 9.82699 4.58843 10.6665 5.30992C11.506 6.0314 12.0594 7.0296 12.2267 8.12383C12.2367 8.2005 12.27 8.26716 12.3233 8.32383L13.4 9.4005C13.5933 9.5905 13.9167 9.48383 13.9333 9.21383C13.9881 8.33455 13.8578 7.45356 13.5509 6.62776C13.244 5.80196 12.7673 5.0497 12.1516 4.41957C11.536 3.78944 10.795 3.29544 9.9765 2.96947C9.15804 2.64351 8.28031 2.49283 7.4 2.52716C7.14 2.53716 7.01333 2.84049 7.14333 3.06383C7.32667 3.38716 7.46667 3.74049 7.55 4.11383ZM8.40667 15.0738C8.66667 15.0405 8.76 14.7272 8.57333 14.5405L7.57333 13.5405C7.51352 13.4811 7.43412 13.4456 7.35 13.4405C6.17619 13.3643 5.07528 12.8446 4.27057 11.9866C3.46586 11.1287 3.01758 9.99678 3.01667 8.8205C3.01654 8.79813 3.00892 8.77645 2.99502 8.75893C2.98112 8.74141 2.96175 8.72905 2.94 8.72383C2.57185 8.64084 2.21801 8.5038 1.89 8.31716C1.66667 8.18716 1.36333 8.31383 1.35667 8.5705C1.35 8.65383 1.35 8.73716 1.35 8.8205C1.35015 9.7116 1.53934 10.5925 1.90508 11.4051C2.27081 12.2177 2.80478 12.9435 3.4717 13.5345C4.13863 14.1255 4.92334 14.5683 5.77403 14.8336C6.62471 15.099 7.52201 15.1809 8.40667 15.0738ZM7.85333 11.9238C7.79899 11.9782 7.76846 12.0519 7.76846 12.1288C7.76846 12.2057 7.79899 12.2794 7.85333 12.3338L10.94 15.4205C11.0533 15.5372 11.24 15.5372 11.3533 15.4205L14.44 12.3338C14.4943 12.2794 14.5249 12.2057 14.5249 12.1288C14.5249 12.0519 14.4943 11.9782 14.44 11.9238L11.3533 8.83383C11.3263 8.80642 11.2942 8.78464 11.2587 8.76978C11.2232 8.75492 11.1851 8.74727 11.1467 8.74727C11.1082 8.74727 11.0701 8.75492 11.0346 8.76978C10.9992 8.78464 10.967 8.80642 10.94 8.83383L7.85333 11.9238Z" fill="#161823"/>
                                                ...
                                                {t('How.your.ads.are.personalized')}</p>
                                            <span className='text-xs text-[#16182399]'>{t('Business.account.description')}</span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='w-100 border-bottom pb-3' onClick={() => toggleVisibility('mute_advertisers')}>
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                           ...
                                           {t('Mute.advertisers')}</p>
                                            <span className='text-xs text-[#16182399]'>{t('Mute.ads.from.specific.advertisers')}</span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                            ...
                            <div ref={sectionRefs.screen_time} className={`${styles.suggestedContent} gap-0`}>
                                <div className='w-100 border-bottom pb-3'>
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <h5 className='h6 text-left'>{t('manage.off.seezitt')} <br />{t('data')}</h5>
                                            <p className='d-flex mt-3 mb-1'>
                                            <svg width="16" height="17" style={{ marginRight: '0.25rem' }} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {t('using.off.seezitt.activity')}</p>
                                            <span className='text-xs text-[#16182399]'>
                                                {t('off.seezitt.data.description')}
                                            </span>
                                            </div>
                                        </div>
                                        <label 
                                ...
                                <div className='w-100 pb-3' onClick={() => toggleVisibility('disconnect_advertisers')}>
                                    <div className={styles.accountCards}>
                                        <div className={styles.settingName}>
                                            ...
                                            {t('Disconnect.advertisers')}</p>
                                            <span className='text-xs text-[#16182399]'>
                                                {t('disconnect.advertisers.description')}
                                            </span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='w-100 border-bottom pb-3'>
                                    <div className={styles.accountCards} onClick={OpenModalDeleteData}>
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p className='d-flex mt-3 mb-1'>
                                            <svg width="16" height="17" style={{ marginRight: '0.25rem' }} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.6666 2.84049V3.50716H14.3333C14.4217 3.50716 14.5064 3.54228 14.569 3.60479C14.6315 3.6673 14.6666 3.75209 14.6666 3.84049V4.50716C14.6666 4.59557 14.6315 4.68035 14.569 4.74286C14.5064 4.80538 14.4217 4.84049 14.3333 4.84049H13.4399L12.9266 13.1738C12.8599 14.2305 12.8299 14.7605 12.6033 15.1605C12.404 15.5144 12.1017 15.7993 11.7366 15.9772C11.3233 16.1772 10.7933 16.1772 9.73659 16.1772H6.26659C5.20659 16.1772 4.67659 16.1772 4.26325 15.9772C3.89814 15.7993 3.59585 15.5144 3.39659 15.1605C3.16992 14.7605 3.13659 14.2305 3.07325 13.1738L2.55992 4.84049H1.66659C1.57818 4.84049 1.4934 4.80538 1.43088 4.74286C1.36837 4.68035 1.33325 4.59557 1.33325 4.50716V3.84049C1.33325 3.75209 1.36837 3.6673 1.43088 3.60479C1.4934 3.54228 1.57818 3.50716 1.66659 3.50716H5.33325V2.84049C5.33325 2.39847 5.50885 1.97454 5.82141 1.66198C6.13397 1.34942 6.55789 1.17383 6.99992 1.17383H8.99992C9.21879 1.17383 9.43552 1.21694 9.63772 1.3007C9.83993 1.38445 10.0237 1.50722 10.1784 1.66198C10.3332 1.81675 10.456 2.00048 10.5397 2.20269C10.6235 2.4049 10.6666 2.62163 10.6666 2.84049ZM6.99992 2.50716C6.91151 2.50716 6.82673 2.54228 6.76422 2.60479C6.7017 2.6673 6.66659 2.75209 6.66659 2.84049V3.50716H9.33325V2.84049C9.33325 2.75209 9.29813 2.6673 9.23562 2.60479C9.17311 2.54228 9.08832 2.50716 8.99992 2.50716H6.99992ZM6.26992 7.00716C6.18151 7.00716 6.09673 7.04228 6.03422 7.10479C5.9717 7.1673 5.93659 7.25209 5.93659 7.3405V12.3405C5.93659 12.4289 5.9717 12.5137 6.03422 12.5762C6.09673 12.6387 6.18151 12.6738 6.26992 12.6738H6.97992C7.06832 12.6738 7.15311 12.6387 7.21562 12.5762C7.27813 12.5137 7.31325 12.4289 7.31325 12.3405V7.3405C7.31325 7.25209 7.27813 7.1673 7.21562 7.10479C7.15311 7.04228 7.06832 7.00716 6.97992 7.00716H6.26659H6.26992ZM8.68659 7.3405V12.3405C8.68659 12.4289 8.7217 12.5137 8.78422 12.5762C8.84673 12.6387 8.93151 12.6738 9.01992 12.6738H9.72992C9.81832 12.6738 9.90311 12.6387 9.96562 12.5762C10.0281 12.5137 10.0633 12.4289 10.0633 12.3405V7.3405C10.0633 7.25209 10.0281 7.1673 9.96562 7.10479C9.90311 7.04228 9.81832 7.00716 9.72992 7.00716H9.01992C8.93151 7.00716 8.84673 7.04228 8.78422 7.10479C8.7217 7.1673 8.68659 7.25209 8.68659 7.3405Z" fill="#161823"/>
                                             ...
                                             {t('clear.offSeezit.data')}</p>
                                            <span className='text-xs text-[#16182399]'>
                                            
                                             {t('clear.offSeezit.description')}
                                            </span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
              ...
              color: darkTheme ? "#fff" : "#000",
                                      ...
                                      <div className='p-4'>
                                            <Typography sx={{ fontSize: '16px',  fontWeight: '500', lineHeight: '21px', letterSpacing: '0.03px'}}  component="p">{t("clear.off.seezitt.description")}</Typography>
                                            <Typography sx={{ fontSize: '16px', marginBottom: '1rem', marginTop: '1rem', fontWeight: '500', lineHeight: '21px', letterSpacing: '0.03px'}}  component="p">
                                                {t("clear.off.seezitt.followup")}</Typography>
                                            <Typography sx={{ fontSize: '16px', fontWeight: '500', lineHeight: '21px', letterSpacing: '0.03px'}}  component="p">{t("clear.off.seezitt.know")}</Typography>
                                            <ul className='list-disc ml-5 mt-4' style={{ fontSize: '14px', fontWeight: '400',}} >
                                                <li>{t("clear.off.seezitt.list.ad.measurement")}</li>
                                                <li>{t("clear.off.seezitt.list.less.relevant.ads")}</li>
                                            </ul>
                                      </div>
                                      <div className='border-top p-3'>
                                            <div className='d-flex gap-2 justify-end'>
                                                <button className="bg-[#fff] text-black font-semibold px-5 rounded-md border text-sm" onClick={CloseModalDeleteData}>
                                                    <p className="text-black font-normal">{t("cancel")}</p>
                                                </button>
                                                <button className="bg-[#FE2C55] text-white font-semibold px-5 rounded-md text-sm" onClick={() => {clearOffData(); CloseModalDeleteData();}}>
                                                    <p className="text-[rgb(255, 59, 92)] font-normal">{t("confirm")}</p>
                                                </button>
                                            </div>
                                      </div>
                                    </Box>
                            ...
                            <div className={`${styles.suggestedContent} gap-0`}>
                                ...
                                <div className={`${styles.pageHeader} mb-0 mt-0 gap-1`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'}`}>{t("screen.time.title")}</h4>
                                    ...
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p className='d-flex mt-3 mb-1'>{t("screen.time.daily.title")}</p>
                                            <span className='text-xs text-[#16182399]'>{t("screen.time.daily.description")}</span>
                                            </div>
                                        </div>
                                       <div className='d-flex'>
                                            <span className='text-lg text-[#16182399]'>{t("off")}</span>
                                    ...
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p className='d-flex mt-3 mb-1'>{t("screen.time.breaks.title")}</p>
                                            <span className='text-xs text-[#16182399]'>{t("screen.time.breaks.description")}</span>
                                            </div>
                                        </div>
                                       <div className='d-flex'>
                                            <span className='text-lg text-[#16182399]'>{t("off")}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                                    ...
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p className='d-flex mt-3 mb-1'>{t("screen.time.sleep.title")}</p>
                                            <span className='text-xs text-[#16182399]'>{t("screen.time.sleep.description")}</span>
                                            </div>
                                        </div>
                                       <div className='d-flex'>
                                            <span className='text-lg text-[#16182399]'>{t("off")}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                                    ...
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p className='d-flex mt-3 mb-1'>
                                           {t("screen.time.weekly.title")}</p>
                                            <span className='text-xs text-[#16182399]'>{t("screen.time.weekly.description")}</span>
                                            </div>
                                        </div>
                                        <label className="toggle-switch !left-1">
                                            ...
                                            style={{zIndex: '9999', height: '2.75rem', width: '4rem', position: 'relative', cursor:'pointer'}}
                                                ...
                                                id="autoScrollCheckbox" 
                                                onChange={(event) => {
                                                    changeScreenTimeUpdates(event);
                                                  
                                                    // Check if parentElement is not null before toggling the class
                                                    const parentElement = event.target.parentElement;
                                                    if (parentElement) {
                                                      parentElement.classList.toggle('checkedToggle', event.target.checked);
                                                    }
                                                  }}
                                            />
                                            <b className={`${themeColor == 'dark' ? '!bg-gray-600': ''} slider`}></b>
                                ...
                                <div className='w-100 border-bottom '>
                                    <Accordion className={ `${darkTheme ? 'bg-transparent': 'bg-[#f8f8f8]'} shadow-none  px-0`}>
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                                <p>{t("summary")} </p>
                                                <span className='text-xs text-[#16182399]'>{t("screen.time.summary.description")}</span>
                                            </div>
                                        </div>
                                        </AccordionSummary>
                            ...
                            <div ref={sectionRefs.filter_keywords}  className={styles.suggestedContent} >
                                <div className={`${styles.pageHeader} mb-0 mt-0`}>
                                    <h4 className={`${darkTheme ? 'text-white' : 'text-black'} mb-0`}>{t("screen.filterKeywords.title")}</h4>
                                </div>
                                <div className='w-100 border-bottom pb-3'>
                                    <div
                                        ...
                                        <div className={styles.settingName}>
                                            <div className='text-left'>
                                            <p>{t("screen.filterKeywords.label")}</p>
                                            <span className='text-xs text-[#16182399]'>{t("screen.filterKeywords.description")}</span>
                                            </div>
                                        </div>
                                       <svg width="7" height="13" viewBox="0 0 7 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.73018 5.86844L1.29921 0.437474C1.16905 0.3073 0.957981 0.3073 0.827814 0.437474L0.356414 0.90888C0.226247 1.03905 0.226247 1.25011 0.356414 1.38028L5.31598 6.33984L0.356414 11.2994C0.226247 11.4296 0.226247 11.6406 0.356414 11.7708L0.827814 12.2422C0.957981 12.3724 1.16905 12.3724 1.29921 12.2422L6.73018 6.81124C6.99055 6.55091 6.99055 6.12878 6.73018 5.86844Z" fill="#161823" fill-opacity="0.5"/>
                                ...
                                >
                                    <div style={{ marginBottom: '24px' }}>
                                        <div
                                            ...
                                            >
                                                {t("modals.passwordChanged.title")}{' '}
                                            </Typography>
                                        </div>
                                    </div>
                        ...
                        >
                            <Box sx={themeColor == 'dark' ? mainModalDarkstyle : mainModalstyle}>
                                ...
                                <div style={{ marginBottom: '24px', width: '100%' }}>
                                    <InputField
                                        placeholder={t('change.password.input.placeholder')}
                                        type="password"
                                        value={user.password}
                    ...
                    <>
                        ...
                        >
                            <Box sx={instructionsModalStyle}>
                                ...
                                <h3 className={styles.instructionsModalTitleText}>{t('change.instructions.title')}</h3>
                                <p className={styles.instructionsModalText}>
                                    {t('change.instructions.subtitle')}
                                </p>
                                <div>
                                    <Button
                                    ...
                                    >
                                        {t('change.instructions.button.open')}
                                    </Button>
                                    <Button
                                        // onClick={handleOpenInstructionsModal}
                                        variant="outlined"
                                    ...
                                    >
                                        {t('change.instructions.button.resend')}
                                    </Button>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ textAlign: 'center', width: '360px' }}>
                                        <span className={styles.infoText}>
                                            {t('change.instructions.info.line1')},{' '}
                                        </span>
                                        <span className={styles.infoText}>{t('change.instructions.info.line2') } </span>
                                        <span className={styles.infoTextLink}>
                                           {t('change.instructions.info.line3')}
                                        </span>
                                    </p>
                                </div>
                            </Box>
                                ...
                                <Box sx={mainModalstyle}>
                                    <div style={{ marginBottom: '24px' }}>
                                        ...
                                        <div>
                                            ...
                                            >
                                                <span>
                                                    {t('set.new.password.description')} <br></br>
                                                </span>
                                                <li>
                                                   {t('set.new.password.rule1')} <br></br>
                                                </li>
                                                <li>{t('set.new.password.rule2')}</li>
                                            </Typography>
                                            <div style={{ marginTop: '20px' }}>
                                                {errorMessage ? (
                                                    <h4
                                    ...
                                    <div style={{ marginBottom: '24px', width: '100%' }}>
                                        <InputField
                                            placeholder={t('set.new.password.input.new')}
                                            type="password"
                                            value={user.password}
                                            onChange={(e: { target: { value: string } }) => {
                                                onUserChange('password', e.target.value);
                                    ...
                                    <div style={{ marginBottom: '24px', width: '100%' }}>
                                        <InputField
                                            placeholder={t('set.new.password.input.confirm')}
                                            type="password"
                                    ...
                                    <Button
                                        ...
                                        sx={mainModalBtnstyle}
                                    >
                                        {t('set.new.password.button.submit')}
                                    </Button>
                                </Box>
                            </Modal>
                        </div>
