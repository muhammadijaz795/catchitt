        ...
        <div className=" w-100 p-3">
            <div className="border-top">
                <div className='text-left d-flex mt-3 '>
                    <span className="pt-1">
                        <svg width="16" height="17" viewBox="0 0 16 17" style={{marginRight: '0.5rem'}} fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <p className='d-flex mb-1'>{t('setDailyTime')}</p>
                        <span className='text-xs text-[#16182399]'>{t('chooseTimeOnSeezitt')}</span>
                        </div>
                </div>
                <div className='text-left d-flex mt-3 '>
                    <span className="pt-1">
                    ...
                    <div>
                        <p className='d-flex mb-1'>{t('getNotified')}</p>
                        <span className='text-xs text-[#16182399]'>{t('closeSeezittToStayWithinTime')}</span>
                        </div>
                </div>
            </div>
                ...
                <div className="d-flex justify-between">
                    <div>
                        <div className='text-left'>
                            <p className='text-base'>{t('setDailyScreenTime')}</p>
                        </div>
                    </div>
            ...
            <label className="flex items-center space-x-2 mb-3 cursor-pointer">
                ...
                <span className="text-gray-900">{t('setSameLimitEveryDay')}</span>
            </label>
            ...
            <label className="flex items-center space-x-2 mt-3 cursor-pointer">
                ...
                <span className="text-gray-900">{t('setCustomLimitPerDay')}</span>
            </label>
