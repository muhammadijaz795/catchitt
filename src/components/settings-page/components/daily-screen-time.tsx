      ...
      <div className=" w-100 p-3">
        <div className="border-top">
            <div className='text-left d-flex mt-3 '>
                ...
                <div>
                    <p className='d-flex mb-1'>Set your daily time</p>
                    <span className='text-xs text-[#16182399]'>Choose how long to spend on Seezitt</span>
                    </div>
            </div>
            <div className='text-left d-flex mt-3 '>
                <span className="pt-1">
                ...
                <div>
                    <p className='d-flex mb-1'>Get notified</p>
                    <span className='text-xs text-[#16182399]'>Close Seezitt to stay within your daily time, or enter a passcode to return to it</span>
                    </div>
            </div>
        </div>
