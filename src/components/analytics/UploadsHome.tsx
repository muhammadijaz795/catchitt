...
const creator = {
    ...
    followers: "18M",
    avatar: "/path-to-anatoly-avatar.jpg",
    videos: [
      { thumbnail: "https://img.freepik.com/free-vector/mass-media-design-concept_98292-7567.jpg?semt=ais_hybrid&w=740", views: "4.9M" },
      { thumbnail: "https://img.freepik.com/premium-photo/vintage-typewriter-with-inserted-sheet-paper-foggy-urban-landscape-dark-river_266732-15963.jpg?semt=ais_hybrid&w=740", views: "143M" },
      { thumbnail: "https://images.pexels.com/photos/4588428/pexels-photo-4588428.jpeg?auto=compress&cs=tinysrgb&w=600", views: "25M" }
    ]
  };
...
const Analytics = () => {
  ...
  const [tabIndexRecomded, setTabIndexReconded] = useState(0);
  const [tabIndexCreator, setTabIndexcreator] = useState(0);
  const tabRecomended = (event: React.SyntheticEvent, newValue: number) => {
    setTabIndexReconded(newValue);
  };
  const tabCreator = (event: React.SyntheticEvent, newValue: number) => {
    setTabIndexcreator(newValue);
  };
                    ...
                    <Container sx={{ mt: 4 }}>
                        ...
                        {tabIndex === 0 && (
                            ...
                            <Tab
                                ...
                                fontWeight: 600,
                                minHeight: '40px',
                                backgroundColor: tabIndexCreator === 0 ? '#000' : '#0000000D',
                                color: tabIndexCreator === 0 ? '#fff' : '#000',
                                borderRadius: 2,
                                px: 3,
                                mx: 1,
                                }}
                            ...
                            {/* <Tab
                                ...
                                fontWeight: 600,
                                minHeight: '40px',
                                backgroundColor: tabIndexCreator === 1 ? '#000' : '#0000000D',
                                color: tabIndexCreator === 1 ? '#fff' : '#000',
                                borderRadius: 2,
                                px: 3,
                                mx: 1,
                                }}
                        ...
                        {tabIndex === 1 && (
                            ...
                            <Box display="flex" justifyContent="space-between" alignItems="center" mb={3} flexWrap="wrap" gap={2}>
                            <Tabs
                            value={tabIndexRecomded}
                            onChange={tabRecomended}
                            textColor="inherit"
                            TabIndicatorProps={{ style: { display: 'none' } }}
                            sx={{ mb: 2,  borderRadius: 2, minHeight: '40px' }}
                            >
                                <Tab
                                    ...
                                    fontWeight: 600,
                                    minHeight: '40px',
                                    backgroundColor: tabIndexRecomded === 0 ? '#000' : '#0000000D',
                                    color: tabIndexRecomded === 0 ? '#fff' : '#000',
                                    borderRadius: 2,
                                    px: 3,
                                    mx: 1,
                                    }}
                                ...
                                <Tab
                                    ...
                                    fontWeight: 600,
                                    minHeight: '40px',
                                    backgroundColor: tabIndexRecomded === 1 ? '#000' : '#0000000D',
                                    color: tabIndexRecomded === 1 ? '#fff' : '#000',
                                    borderRadius: 2,
                                    px: 3,
                                    mx: 1,
                                    }}
                                ...
                                <Tab
                                    ...
                                    fontWeight: 600,
                                    minHeight: '40px',
                                    backgroundColor: tabIndexRecomded === 2 ? '#000' : '#0000000D',
                                    color: tabIndexRecomded === 2 ? '#fff' : '#000',
                                    borderRadius: 2,
                                    px: 3,
                                    mx: 1,
                                    }}
                        ...
                        {tabIndexCreator == 1 &&(
                            ...
                            <Box
                                ...
                                >
                                    {/* <img style={{ height: '2.5rem'}} src="data:image/png;base64," alt="" /> */}
                                    <img style={{ height: '1.75rem'}} src="https://s3-alpha-sig.figma.com/img/ab49/e101/99d8c7ae2f0bea8d5cb521ab02cf4a97?Expires=1745798400&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=izb7yJKI3MxrbnmjISi9UIP4UCRvlC1e3wLo874eW-~sKtrumeBW2gRlJjxTVbgXjEX-5yeF6pr7x77S1XmI5BP7fiag195L9kqPB0Gqq7YWmmRoI2jPfyONiQPS9oAwi8AO4F-Ipt9eBqFJXEUvbHZYNGNMBfUeZldZ1Ep7fjItb60bTQz59009iISIMMPE06KC3Vu9Z6Rf4k7RkD8s8Nzr4UNZhaPaqO9Wc9BfDEyEDxC4P43ZFTI~3sLskTR2lbwD6OJGQGJexKXNuUnWL3AXv4tMs19POoEDWzD00Lkd5xBFE7UnUWmgSstUdmP2F0isKJm3unj5P8ELyUlU-w__" alt="" />
                                    <span className='position-absolute text-base text-[#47494F] font-semibold'>1</span>
                                </Box>
                              <Avatar src={creator.avatar} alt={creator.name} sx={{ width: 40, height: 40, mr: 2 }} />
                              <Box>
                                <Typography variant='body2' fontWeight="bold">{creator.name}</Typography>
                                <Typography variant="caption" color="text.secondary">{creator.description}</Typography>
                              </Box>
                              <Box sx={{ ml: 'auto' }}>
                                ...
                                <Grid item xs={4}  key={index}>
                                  <Box sx={{ position: 'relative' }}>
                                    <CardMedia
                                      ...
                                      image={video.thumbnail}
                                      alt={`video-${index}`}
                                      sx={{ height: 150, borderRadius: 2, objectFit: 'cover' }}
                                    />
                                    {/* View Count Overlay */}
                                    <Box sx={{
                                      position: 'absolute',
