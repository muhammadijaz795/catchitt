...
function CustomPlayer({ isMuted, onMuteToggle, src, videoModal, post, thumbnailImage, controls, number, onMediaPlay, visibleReportPopup, onEnded  }: any) {
  ...
  const [showVolumeSlider, setShowVolumeSlider] = useState(false);
    ...
    return (
        <>
        <div style={{ padding: '20px', width: '300px', position:'absolute', zIndex:'2323' }}>
          <div>
                    ...
                    <div className={style.videoMediaContainer}>
                        <div role="button" aria-label="Play" aria-pressed="true" data-e2e="video-play" className={style.playButton} onClick={togglePlayPause}>
                            {isPlaying ? (
                                ...
                                (<svg stroke='rgba(0,0,0,0.20)' strokeWidth="1px" width="20" data-e2e="" height="20" viewBox="0 0 48 48" fill="#fff" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M12 8.77702C12 6.43812 14.5577 4.99881 16.5569 6.21266L41.6301 21.4356C43.5542 22.6038 43.5542 25.3962 41.6301 26.5644L16.5569 41.7873C14.5577 43.0012 12 41.5619 12 39.223V8.77702Z"></path>
                                </svg>)}
                        </div>
