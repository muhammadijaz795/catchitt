...
export const Post: React.FC<PostProps> = memo(
    ({ className, post, startedIds, endedIds, isBookmarked, profileAvatar }) => {
        ...
        const [anchors, setAnchors] = useState<{ more: null; share: null }>({
            more: null,
            share: null,
        });
                                        ...
                                        <Box sx={styleComment}>
                                            ...
                                            >
                                                <VideoPlayer
                                                    ...
                                                    onStart={() =>
                                                        handleStartWatching(postData.mediaId)
                                                    }
                                                    onEnd={() =>
                                                        handleEndWatching(postData.mediaId)
                                                    }
                                                />
                                            </div>
                                            ...
                                            <div className={styles.userCommentDiv}>
                                                ...
                                                >
                                                    <div className={styles.commentsHeaderDiv}>
                                                        ...
                                                        <div
                                                            className={
                                                                styles.postCaptionContainerComments
                                                            }
                                                        >
                                                                ...
                                                                >
                                                                    <div>
                                                                        <img
                                                                            ...
                                                                            alt=""
                                                                            className={
                                                                                styles.profilePicImg
                                                                            }
                                                                        />
                                                                    </div>
                                                                    <div
                                                                        className={
                                                                            styles.userDetailsDiv
                                                                        }
                                                                    >
                                                                        <h4
                                                                            className={
                                                            ...
                                                            <div className={styles.postText}>
                                                                ...
                                                                >
                                                                    ...
                                                                    <p>
                                                                        {postData.sound?.title} -{' '}
                                                                        {
                                                                            postData.sound?.owner
                                                                                ?.name
                                                                        }
                                                                    </p>
                                                                </Box>
                                                            ...
                                                            <div
                                                                className={
                                                                    styles.postInteractionContainerComment
                                                                }
                                                            >
                                                                <div
                                                                    className={
                                                                        styles.interactionDivComment
                                                                    }
                                                                >
                                                                    <Button
                                                                        className={
                                                    ...
                                                    <div className={styles.giftsReceivedDiv}>
                                                        <p className={styles.giftsText}>
                                                            Gifts received
                                                        </p>
                                                        {postData.receivedGifts
                                                            .slice(-7)
                                                            .map((gift, i) => (
                                                                <div
                                                                    className={
                                                                        styles.giftsReceivedImgDiv
                                                                    }
                                                                >
                                                                    <img
                                                                        key={i}
                                                    ...
                                                    {postData.comments.map((comment, i) => (
                                                        <Comment
                                                            ...
                                                            handleLikeComment={dHandleLikeComment}
                                                        />
                                                    ))}
                                                </div>
                                                <div
                                                    ...
                                                    >
                                                        <div className={styles.commentInputDiv}>
                                                            {isReplying && (
                                                                <div
                                                                    className={
                                                                        styles.replyingToTextDiv
                                                                    }
                                                                >
                                                                    replying to{' '}
                                                                    <div
                                                                        className={
                                                                            styles.replyingToMessage
                                                                        }
                                                                    >
                                                                        {replyingMessage}
                                                                        <IconButton
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <path
                                                                                    fill-rule="evenodd"
                                                                                    clip-rule="evenodd"
                                                                                    d="M10 18.5C14.4183 18.5 18 14.9183 18 10.5C18 6.08172 14.4183 2.5 10 2.5C5.58172 2.5 2 6.08172 2 10.5C2 14.9183 5.58172 18.5 10 18.5ZM8.28033 7.71967C7.98744 7.42678 7.51256 7.42678 7.21967 7.71967C6.92678 8.01256 6.92678 8.48744 7.21967 8.78033L8.93934 10.5L7.21967 12.2197C6.92678 12.5126 6.92678 12.9874 7.21967 13.2803C7.51256 13.5732 7.98744 13.5732 8.28033 13.2803L10 11.5607L11.7197 13.2803C12.0126 13.5732 12.4874 13.5732 12.7803 13.2803C13.0732 12.9874 13.0732 12.5126 12.7803 12.2197L11.0607 10.5L12.7803 8.78033C13.0732 8.48744 13.0732 8.01256 12.7803 7.71967C12.4874 7.42678 12.0126 7.42678 11.7197 7.71967L10 9.43934L8.28033 7.71967Z"
                                                                                    fill="rgb(255, 59, 92)"
                                                                                />
                                                                            </svg>
                                                                        </IconButton>
                                                            ...
                                                            <div className={styles.replyingToDiv}>
                                                                <img
                                                                    ...
                                                                    alt={''}
                                                                    className={
                                                                        styles.avatarImgCircleCommentInputField
                                                                    }
                                                                />
                                                                <InputField
                                                        ...
                                                        <Box sx={giftsModalStyle}>
                                                            ...
                                                            <div className={styles.giftsBottomDiv}>
                                                                ...
                                                                >
                                                                    ...
                                                                    <IconButton
                                                                        onClick={
                                                                            handleOpenRechargeBalanceModal
                                                                        }
                                                                    >
                                                                        <img
                                                                            src={arrowRightIcon}
                                    ...
                                    <Box sx={defModalStyle}>
                                        ...
                                        <Box sx={pricesBox}>
                                            {[...Array(8)].map((_, index) => {
                                                ...
                                                const price = ((index + 1) * 1.0).toFixed(2);
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        key={index}
                                                        onClick={() =>
                                                            handleItemClick(index, amount, price)
                                                        }
                                                    >
                                    ...
                                    <Box sx={defModalStyle}>
                                        ...
                                        >
                                            <div className={styles.giftsBottomLeftDiv}>
                                                ...
                                                <p className={styles.giftCoinsText}>
                                                    {selectedAmount} Cesium
                                                </p>
                                            </div>
                                            <div className={styles.giftsBottomRightDiv}>
                                                <p className={styles.giftCoinsAmountText}>
                                                    QAR {selectedPrice}
                                                </p>
                                            </div>
                                        </div>
                                        <div
                                            className={styles.giftsBottomDivPaymentMethod}
                                            style={{
                                                marginBottom: '32px',
                                                paddingBottom: '32px',
                                                borderBottom: '1px solid #EAEAEA',
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className={styles.giftsBottomRightDiv}>
                                                    <p
                                                        className={styles.giftCoinsAmountText}
                                                        style={{ color: '#222' }}
                                                    >
                                                        QAR {selectedPrice}
                                                    </p>
                                ...
                                <div>
                                    <div className={styles.postCaptionContainersMobile}>
                                        <div className={styles.postCreatorMobile}>
                                            <div className={styles.userContainer}>
                                                ...
                                                <div className={styles.userDetailsDivMobile}>
                                                    <h4 className={styles.userNameTextMobile}>
                                                        @{postData.user.username}
                                                    </h4>
                                                    <h4
                                                        onClick={() => {
                                                        ...
                                                        className={styles.userSubTextMobile}
                                                    >
                                                        {followLoading
                                                            ? '...'
                                                            : postData.user.isFollowed
                                        ...
                                        <div className={styles.postTextMobile}>
                                            {postData.description && (
                                                <h4 className={styles.captionTextMobile}>
                                                    {showLess ? (
                                                        <span>
                                                            {postData.description?.slice(0, 10) +
                                                                '...'}
                                                            <b onClick={() => setShowLess(false)}>
                                                                SEE MORE
                                                            </b>
                                                        </span>
                                                    ) : (
                                ...
                                <div className={styles.postInteractionContainer}>
                                    ...
                                    <div className={styles.interactionDiv}>
                                        ...
                                        >
                                            <>
                                                ...
                                                <div className={styles.mobileOnly}>
                                                    {<BookmarkMobile bookmarked={bookMarkStatus} />}
                                                </div>
                                    ...
                                    <div className={styles.interactionDiv}>
                                        <Button
                                            ...
                                            id="demo-positioned-button"
                                            aria-controls={
                                                openShare ? 'demo-positioned-menu' : undefined
                                            }
                                            aria-haspopup="true"
                                    ...
                                    <div className={styles.interactionDiv}>
                                        ...
                                        >
                                            <MenuItem
                                                onClick={() =>
                                                    handleSaveVideo(postData.reducedVideoUrl)
                                                }
                                                className={styles.menuItems}
                                            >
                                                <div className={styles.menuItemsSvgs}>
