...
export interface TermsPageProps { className?: string }
                ...
                <div className={styles.middleSectionDiv}>
                    ...
                    <div className={styles.suggestedContent}>
                        <div className={styles.cards}>
                            ...
                            <div>
                                <p className={styles.paragraphsText}>Last updated: September 15, 2022</p>
                                <p className={styles.paragraphsText}>Please read these terms and conditions carefully before using Our Service.</p>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>For the purposes of these Terms and Conditions:</p>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        <br></br>
                                        Content  refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made
                                        ...
                                        the Company regarding the use of the Service.<br></br >
                                        Third - party Social Media Service means any services or content(including data, information, products or services) provided by
                                        ...
                                        individual is accessing or using the Service, as applicable.<br></br>
                                    </p >
                                </div >
                            </div >
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.</p>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        is subject to any rights of another person or entity other than You without appropriate authorization, or a name that is otherwise
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        display on or through the Service and You are responsible for protecting those rights. You agree that this license includes the right
                                        for Us to make Your Content available to other users of the Service, who may also use Your Content subject to these Terms.
                                    </p>
                                </div>
                            </div>
                            ...
                            <ul>
                                <p>
                                    <p className={styles.paragraphsText}> Unlawful or promoting unlawful activity.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}>
                                        {" "}
                                        Defamatory, discriminatory, or mean-spirited content, including references or commentary about religion, race, sexual orientation,
                                ...
                                <p>
                                    <p className={styles.paragraphsText}>
                                        Containing or installing any viruses, worms, malware, trojan horses, or other content that is designed or intended to disrupt, damage,
                                ...
                                <p>
                                    <p className={styles.paragraphsText}>
                                        {" "}
                                        Infringing on any proprietary rights of any party, including patent, trademark, trade secret, copyright, right of publicity or other
                                        rights.
                                    </p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}>Impersonating any person or entity including the Company and its employees or representatives.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}> Violating the privacy of any third person.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}> False information and features.</p>
                                </p>
                            </ul>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        appropriate and complies with this Terms, refuse or remove this Content. The Company further reserves the right to make formatting and
                                        edits and change the manner of any Content. The Company can also limit or revoke the use of the Service if You post such objectionable
                                        Content. As the Company cannot control all content posted by users and/or third parties on the Service, you agree to use the Service
                                        at your own risk. You understand that by using the Service You may be exposed to content that You may find offensive, indecent,
                                        incorrect or objectionable, and You agree that under no circumstances will the Company be liable in any way for any content, including
                                        any errors or omissions in any content, or any loss or damage of any kind incurred as a result of your use of any content.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>Although regular backups of Content are performed, the Company does not guarantee there will be no loss or corruption of data.</p>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>You agree to maintain a complete and accurate copy of any Content in a location independent of the Service.</p>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        of our copyright agent via email at info@SeezItt.com and include in Your notice a detailed description of the alleged infringement.
                                    </p>
                                </div>
                            </div>
                            ...
                            <ul>
                                <p>
                                    {" "}
                                    <p className={styles.paragraphsText}> An electronic or physical signature of the person authorized to act on behalf of the owner of the copyright's interest.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}>
                                        {" "}
                                ...
                                <p>
                                    <p className={styles.paragraphsText}>Identification of the URL or other specific location on the Service where the material that You claim is infringing is located.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}>Your address, telephone number, and email address.</p>
                                </p>
                                <p>
                                    <p className={styles.paragraphsText}>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        You can contact our copyright agent via email at info@SeezItt.com. Upon receipt of a notification, the Company will take whatever
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>Our Service may contain links to third-party web sites or services that are not owned or controlled by the Company.</p>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        other information, for business interruption, for personal injury, loss of privacy arising out of or in any way related to the use of
                                        or inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection
                                        with any provision of this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        ...
                                        foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind that the Service will meet Your
                                        requirements, achieve any intended results, be compatible or work with any other software, applications, systems or services, operate
                                        without interruption, meet any performance or reliability standards or be error free or that any errors or defects can or will be
                                        corrected.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>
                                        Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation or warranty of any
                            ...
                            <div>
                                <div>
                                    <p className={styles.paragraphsText}>If you have any questions about these Terms and Conditions, You can contact us:</p>
                                </div>
                            </div>
