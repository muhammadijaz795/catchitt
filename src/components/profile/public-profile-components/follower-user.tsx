...
const PbulicFollowerUser: React.FC<{ user: any; onRemoveClick: any; popupClose: any, removeCurrentUser: any }> = ({
    user,
    onRemoveClick,
    popupClose,
    removeCurrentUser
            ...
            <div className={`${styles.user} user-class-${user?._id}`}>
                <div className={styles['div-18']}>
                    ...
                    <div className='d-flex'>
                        {followBackText == 'Follow Back' && <div onClick={()=> handleFollowBack(user?.followed_userID?._id)}  style={button}>
                            {followBackText}
                        </div>}
                        {followBackText != 'Follow Back' && <div onClick={()=> handleFollowBack(user?.followed_userID?._id)}  style={buttonDefault}>
                            {followBackText}
                        </div>}
