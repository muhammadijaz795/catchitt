...
export default function COPY_AND_SEND_MODAL_HOME({
    ...
    return (
        <div className='modal-shares'>
            ...
            <DialogTitle sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#000' }}>
                <span className='text-black'>Share to</span>
            ...
            <DialogContent >
                    <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                        <div className={style.menuItem} onClick={copyHandler}>
                            <div className="h-10 w-100 overflow-hidden flex items-center justify-between p-2 bg-neutral-200 rounded-sm">
                                <span className='overflow-hidden' style={{ maxWidth: '21rem' }}>https://web.seezitt.com/kamranaf078e/video/6730f96e97a617aea1ba8581</span>
