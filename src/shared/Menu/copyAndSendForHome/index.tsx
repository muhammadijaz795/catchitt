    ...
    return (
        <div className='modal-shares'>
            ...
            <DialogTitle className={isDarkTheme ? 'bg-[#181818]' : 'bg-white'} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#000' }}>
                <span className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `} >{t('Shareto.text')}</span>
            ...
            <DialogContent className={isDarkTheme ? 'bg-[#181818] !px-2.5' : 'bg-white !px-2.5'}>
                    ...
                    <MenuItem onClick={repostVideoEventHandle} style={{ padding: '0px', margin: '0px' }}>
                        <div className={style.menuItem} >
                            ...
                            <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `} >{t('Repost.text')}</p>
                        </div>
                    </MenuItem>
                    </Grid>
                    <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={popupHandler}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Sendtofriends.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                    ...
                    <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={generateEmbedCodeHandler}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Embed.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                        <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={shareToWhatsApp}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Whatsapp.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                        <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={shareToFacebook}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Facebook.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                        <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={shareToTwitter}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Twitter.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                        <Grid item xs={3}>
                        <MenuItem onClick={handleClose} style={{ padding: '0px', margin: '0px' }}>
                            <div className={style.menuItem} onClick={shareToLinkedIn}>
                                ...
                                <p className={`${ThemeColor === 'dark' ? 'text-white' : 'text-black'} font-medium `}>{t('Linkedinn.text')}</p>
                            </div>
                        </MenuItem>
                        </Grid>
                </Grid>
