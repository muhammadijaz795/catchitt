        ...
        <div className={style.DivHeaderCenterContainer}>
            <div className={style.DivSearchFormContainer}>
                <form data-e2e="search-box" className={style.SearchFormElement} action="/search">
                    ...
                    value={Search} role="combobox" aria-controls="" aria-label="Search" aria-expanded="false" aria-autocomplete="list" data-e2e="search-user-input" className={style.SearchInputElement}  /><span className={style.SearchSpanSpliter}></span>
